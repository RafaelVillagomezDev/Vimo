            ...
            {data.images.map((image: { url: string | undefined }, index: number) => (
                <CardContainer key={index + '**' + data.id}>
                    ...
                    <CardBox>
                        <CardBoxTitle>
                            {name}
                            <CardIcon color="orange">workspace_premium</CardIcon>
                        </CardBoxTitle>
                        <CardText>
                            <CardIcon color="black">map</CardIcon>
                            {address}
                        </CardText>
                        <CardText>
                            <CardIcon color="black">flatware</CardIcon>
                            {type_food}
                        </CardText>
                        <CardText>
                            <LinkCard to={web}>
                                <CardIcon color="black">web_traffic</CardIcon>
                                {web}
                            </LinkCard>
                        </CardText>
                        <CardText>
                            <BuuttonLink to={'restaurants/' + data.id}>Ver más</BuuttonLink>
                        </CardText>
                    </CardBox>
                </CardContainer>
            ))}
