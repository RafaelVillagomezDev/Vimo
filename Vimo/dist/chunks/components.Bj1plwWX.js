...
`,oe=l.button`
    ...
    font-weight: 400;
    cursor: pointer;
`;function ae(){return e.jsx(R,{children:e.jsxs(S,{children:[e.jsx(L,{children:"ZappyMap"}),e.jsxs(T,{children:[e.jsxs(I,{children:[e.jsx(A,{to:"./legales",children:"¿Quienes somos?"}),e.jsx(A,{to:"./legales",children:"Información de contacto"})]}),e.jsxs(I,{children:[e.jsx(A,{to:"./legales",children:"Preguntas frecuentes"}),e.jsx(A,{to:"./legales",children:"Condiciones legales"})]}),e.jsxs(I,{children:[e.jsxs(ie,{to:"https://yandrydev.es/",children:[e.jsx(O,{children:"rss_feed"}),"Redes sociales"]}),e.jsxs(ie,{to:"https://yandrydev.es/",children:[e.jsx(O,{children:"copyright"}),"ZappyMap Inc"]})]}),e.jsx(I,{})]})]})})}const se=l.nav`
