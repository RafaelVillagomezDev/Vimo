...
export const StepThreeSchema = z.object({
  images: z
    ...
    .refine((files) => files && (files instanceof FileList || Array.isArray(files)), "Debes seleccionar imágenes.")
...
// --- ESQUEMA TOTAL (Para el envío final) ---
export const FullFormSchema = StepOneSchema.merge(StepTwoSchema).merge(StepThreeSchema);

export type FormSiteData = z.infer<typeof FullFormSchema>;